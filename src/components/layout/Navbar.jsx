          ...
          {NAV_ITEMS.map(({ label, to }) => (
            <li key={to}>
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-light text-lg leading-7 tracking-[1px] transition-colors px-2 py-1 ${
                    isActive
                      ? 'text-[#CDBB88]'
        ...
        <div className="lg:hidden flex flex-col px-6 py-4 gap-2 bg-white dark:bg-[#0B0F19] border-t border-gray-200 dark:border-gray-800 transition-colors duration-200 absolute w-full shadow-lg">
          {NAV_ITEMS.map(({ label, to }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `block font-light text-lg leading-7 tracking-[1px] transition-colors py-3 px-4 rounded-md ${
                  isActive
